...
* Added List<Widget> extensions for Row, Column, Stack, Wrap, Flex, ListView, IndexedStack, and PageView
* All extensions now properly support Key parameters
* Added convenient getter shortcuts (e.g., `inCenter`, `inExpanded`, `rowSpaceBetween`, `columnCenter`)
* Organized extensions into logical categories for better maintainability

## 0.0.2

*  Added widget extensions on some selective widgets

## 0.0.1

*  Mira Widgets — A companion package providing versatile, reusable widgets and primitives for the Mira UI ecosystem
*  Swift UI inspired
