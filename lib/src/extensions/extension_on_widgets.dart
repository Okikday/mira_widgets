...
extension ExtensionOnWidgets on Widget {
  ...
  Padding padding(EdgeInsets padding, {Key? key}) =>
  ...
  SizedBox sizedBox({Key? key, double? w, double? h}) =>
      SizedBox(key: key, width: w, height: h, child: this);
  SizedBox squareSizedBox(double dimension, {Key? key}) =>
      sizedBox(key: key, w: dimension, h: dimension);
  SizedBox sizeSizedBox(Size size, {Key? key}) =>
      sizedBox(key: key, w: size.width, h: size.height);
  ...
  AspectRatio aspectRatio(double ratio, {Key? key}) =>
      AspectRatio(key: key, aspectRatio: ratio, child: this);
  ...
  Expanded expanded([int flex = 1, Key? key]) =>
  ...
  Transform translate(Offset offset, {Key? key}) =>
      Transform.translate(key: key, offset: offset, child: this);
  ...
  GestureDetector tapGesture(void Function() onTap, {Key? key}) =>
  ...
  Offstage offstage([bool offstage = true, Key? key]) =>
  ...
  Theme theme(ThemeData data, {Key? key}) =>
      Theme(key: key, data: data, child: this);
